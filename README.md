...
- **Handles arbitrarily deep nesting.** Inspect deeply nested structures (1000+ levels) without stack overflow errors. The iterative implementation efficiently handles any nesting depth while maintaining excellent performance.
